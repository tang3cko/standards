---
name: unity-design-tokens
description: USS variables for colors, fonts, spacing in UI Toolkit. Use when defining or using design tokens in Common.uss.
---
...
When defining font size tokens, ensure they meet platform-specific minimum requirements:
