...
From [Unity documentation](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.8/manual/Actions.html):
> Action maps are most useful for grouping actions that contextually belong together. For example, one common usage is to separate the actions that can be performed in the UI or in the main menu from those that can be performed during gameplay.
...
Create `Assets/Settings/PlayerInputActions.inputactions`:
...
namespace ProjectName.Input
{
    ...
    public class MockInputReaderSO : InputReaderSO
    {
        ...
        // Protected methods in base class to invoke events
    }
}
```
...
- [Actions and Action Maps](https://docs.unity3d.com/Packages/com.unity.inputsystem@1.8/manual/Actions.html)
- [Switching Action Maps Guide](https://onewheelstudio.com/blog/2021/6/27/changing-action-maps-with-unitys-new-input-system)
