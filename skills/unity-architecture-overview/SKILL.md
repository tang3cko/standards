---
name: unity-architecture-overview
description: ScriptableObject architecture selection guide. EventChannel, Variable, RuntimeSet, RES patterns. Use when choosing Unity architecture.
---
